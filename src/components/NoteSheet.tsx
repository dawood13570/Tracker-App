...
export default function NoteSheet({
  ...
  const loadNotes = useCallback(async () => {
    ...
    if (fetched.length === 0) {
      ...
      // Auto-generated initial note seed (isAutoGenerated = true)
      await createNote(scope, dateKey, seed, customTitle, true);
  ...
  const handleAddNew = async () => {
    // Explicit user action (isAutoGenerated = false)
    const newNote = await createNote(scope, dateKey, '', customTitle, false);
