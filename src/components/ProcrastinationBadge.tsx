...
type BadgeLevel = 'subtle' | 'moderate' | 'alarming';

const getBadgeLevel = (count: number): BadgeLevel => {
...
export function ProcrastinationBadge({ count }: ProcrastinationBadgeProps) {
  ...
  return (
    <View style={[styles.badge, styles[level]]}>
      <Text style={[styles.badgeText, styles[`${level}Text` as keyof typeof styles]]}>
