...
export default function NotesHistoryScreen() {
  ...
  const loadNotes = useCallback(async () => {
    await db.run(sql`
      ...
      WHERE created_at = updated_at 
         ...
         OR content LIKE '%Daily Summary%'
         OR id <= 42;
    `);

    const data = await getAllNotesSummaries();
    setNotesList(data);
  }, []);
  ...
  const filtered = useMemo(() => {
    ...
    return notesList.filter((n) => {
      if (!showAutoGenerated && n.isAutoGenerated) return false;
  ...
  }, [notesList, search, scopeFilter, showAutoGenerated]);
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.autoGeneratedToggleRow}>
        <Text style={styles.autoGeneratedToggleLabel}>Show auto-generated notes</Text>
        <Switch
          value={showAutoGenerated}
          onValueChange={setShowAutoGenerated}
