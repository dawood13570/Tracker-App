...
- [ ] 1.2.2 — Render the list using `FlatList` (not `ScrollView` — learn why FlatList is better for lists, 'Note' apparently FlashList is superior to FlatList, so check that out.)
